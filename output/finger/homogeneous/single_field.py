...
def main():
    ...
    cell = "finger"
    params['mesh'] = "./cell_data/"+cell+"/hole_coarse.xdmf"
    params['domains'] = "./cell_data/"+cell+"/hole_coarse_domains.xdmf"
    params['boundaries'] = "./cell_data/"+cell+"/hole_coarse_boundaries.xdmf"

    params['mesh_init'] = "./cell_data/"+cell+"/hole_coarse.xdmf"
    ...
    # Boundary Conditions
    params['surface_nodes'] = np.loadtxt("./cell_data/"+cell+"/cell_surface_coarse_vertices.txt")
    params['surface_faces'] = np.loadtxt("./cell_data/"+cell+"/cell_surface_coarse_faces.txt", int)
